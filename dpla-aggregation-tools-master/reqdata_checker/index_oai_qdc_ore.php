...
<html>
    <head>
        <title>OAI Aggregation Tools &raquo; Required Data Checker (Oregon)</title>
    ...
    <body>
        ...
        <h1>Required Data Checker - Qualified Dublin Core (Oregon)</h1>
        <p>Check incoming oai_qdc for required data for Mountain West Digital Library.</p>
        <div class="formwrap">
