...
<html>
    ...
    <body id="mappingchecker">
        ...
        <h1>Mapping Checker - Simple Dublin Core</h1>
        <p>Check incoming oai_dc feeds for correct qualified Dublin Core mappings. Bright yellow fields are required fields for Mountain West Digital Library. Light yellow fields are recommended fields for MWDL.</p>
        <div id="formwrap">
          ...
          <?php
                    ...
                    <input type="submit"/>
                    <a class="clearbutton" href="index_oai_dc.php">&times;</a>
